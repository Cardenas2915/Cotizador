...
<div class="flex w-full flex-col">
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" action="{{route('categoria')}}" method="POST" id="formCategoria" enctype="multipart/form-data">
                            @csrf
                            <div id="contenedorInput">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre categoria:</label>
                                <input type="text" value="{{old('name')}}" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" >
                            </div>
                            <div class="mb-6">
    ...
    <div class="px-6">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            @if ($categorias->count())
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <img class="h-8" src="{{asset('categorias'. '/' . $categoria->imagen)}}" alt="imagen de {{ $categoria->name }}">
                        </td>
                        <td class="px-6 py-4">
            ...
            @else
            <p class="text-black font-bold px-6 py-4 bg-blue-400 text-center shadow">No hay categorias registrados</p>
            @endif
        </div>
            <div class="mt-3 px-6">
                {{ $categorias->links() }}
